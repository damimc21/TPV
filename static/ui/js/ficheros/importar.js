...
(function () {
    ...
    const HEADERS_PRODUCTOS = ['nombre', 'departamento', 'precio', 'activo', 'nombre_factura', 'nombre_comanda'];
    ...
    function parseCSV(text) {
        ...
        parsedHeaders = parseCsvLine(rawLines[0], delimiter).map(normalizeHeader);
        parsedRows = rawLines.slice(1).map((line, index) => {
